...
import de.glawleschkoff.scannerapp.databinding.FragmentBtebscanBinding;
...
public class BTEBScanFragment extends Fragment implements ScanManager.DataListener {

    private FragmentBtebscanBinding binding;
    private BTEBViewModel btebViewModel;
    private SuperViewModel superViewModel;
    private ScanManager scanManager;

    public static BTEBScanFragment newInstance() {
        return new BTEBScanFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentBtebscanBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
            ...
            if(getViewLifecycleOwner().getLifecycle().getCurrentState() == Lifecycle.State.RESUMED){
                if(btebViewModel.getResponseUSERALBDetails().getValue().getErrorMessage() != null){
                    ...
                    new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Navigation.findNavController(requireView()).navigate(R.id.action_btebScanFragment_self);
                                }
                            })
                    ...
                    Navigation.findNavController(requireView())
                            .navigate(R.id.action_btebScanFragment_to_btebSelectFragment);
                }
            }
        });
        ...
        binding.bt1.setOnClickListener(x -> {
            Navigation.findNavController(requireView())
                    .navigate(R.id.action_btebScanFragment_to_menuFragment);
        });

        superViewModel.getMitarbeiter().observe(getViewLifecycleOwner(), x -> {
            if(x==null){
                Navigation.findNavController(requireView())
                        .navigate(R.id.action_btebScanFragment_to_loginFragment);
            }
        });
    }
