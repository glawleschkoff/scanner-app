...
public class BTZSSelect1Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btzsViewModel.getResponseUSERALBDetails().observe(getViewLifecycleOwner(),x -> {
            if(btzsViewModel.getResponseUSERALBDetails().getValue().getResponse()!=null){
                btzsViewModel.requestBitmap(btzsViewModel.getResponseUSERALBDetails()
                                .getValue().getResponse().getKundenAuftrag(),
                        btzsViewModel.getResponseUSERALBDetails()
