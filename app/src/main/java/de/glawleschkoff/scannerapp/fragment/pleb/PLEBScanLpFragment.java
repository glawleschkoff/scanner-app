...
import de.glawleschkoff.scannerapp.databinding.FragmentPlebscanlpBinding;
...
public class PLEBScanLpFragment extends Fragment implements ScanManager.DataListener {

    private FragmentPlebscanlpBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentPlebscanlpBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.text.setOnClickListener(x -> {
            plebViewModel.setTempLagerplatz("4");
        });
            ...
            if(getViewLifecycleOwner().getLifecycle().getCurrentState() == Lifecycle.State.RESUMED){
                if(!validLagerplatz(plebViewModel.getTempLagerplatz().getValue())){
                    new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    Navigation.findNavController(requireView()).navigate(R.id.action_PLEBScanLpFragment_to_PLEBSelectFragment);
                                }
                            })
                    ...
                    Navigation.findNavController(requireView())
                            .navigate(R.id.action_PLEBScanLpFragment_to_PLEBSelectFragment);
                }
            }
