...
public class PLEBCardRVAdapter extends RecyclerView.Adapter<PLEBCardRVAdapter.MyViewHolder> {
    ...
    public PLEBCardRVAdapter(List<RVItem> rvItemList, Context context, ClickInterface clickInterfaceExtern){
    ...
    @NonNull
    @Override
    public PLEBCardRVAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rtebcardrv,parent,false);
        return new PLEBCardRVAdapter.MyViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull PLEBCardRVAdapter.MyViewHolder holder, int position) {
